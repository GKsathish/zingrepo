...
const App = () => {
  ...
  const handleRowClick = (item) => {
    ...
    setShowAlert(false); // Hide alert when a row is selected
  };
  ...
  return (
    <div className="container-fluid">
      ...
      <Row>
        {loading ? (
          <div className="d-flex  flex-column justify-content-center align-items-center  m-5 p-5 ">
            ...
            <h1 className="m-5 p-5 fw-bold " style={{color:'#0090CF'}}>loading </h1>
          </div>
        ) : (
          <>
            <Col>
                  ...
                  <tbody>
                    {sortedData.map((item) => (
                      ...
                      >
                        ...
                        <td>
                          {item.status === "Approved" || item.status === "approved" || item.status === "ACTIVE"
                            ? item.status
                            : "N/A"}
                        </td>
                        <td>
      ...
      <Row>
        <Col>
          {selectedData && (
            <div className="mt-4 shadow p-2  d-flex   justify-content-even">
              <div>
